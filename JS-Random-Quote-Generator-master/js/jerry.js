...
const paraSource = document.querySelector(".source")
const paraCitation = document.querySelector(".citation")
const paraYear = document.querySelector(".year")
const button = document.getElementById("loadQuote")
const body = document.querySelector("body")



window.setInterval(printPara, 5000);
...
function printPara(){
    const quote = getPara();
    if(!isNaN(quote['citation']))
        paraCitation.textContent = quote['citation'];
    else
        paraCitation.textContent = "";
    if(isNaN(quote['year']))
        paraYear.textContent = quote['year'];
    else
        paraYear.textContent = "";


    paraQuote.textContent = quote['quote'];
    paraSource.textContent = quote['source'];
